...
for i in content:
    ...
    line=line.split()
    #line = [word for word in line[2:] if not word in set(stopwords.words('english'))]
    line = ' '.join(line)
    print(line)
    train1.write(line)
    train1.write("\n")
...
for i in content:
    ...
    line=re.sub('[^a-z]', ' ',line)
    line=line.split()
   # line = [word for word in line[1:] if not word in set(stopwords.words('english'))]
    line = ' '.join(line)
   # print(line)
    enty1.write(line)
    enty1.write("\n")
